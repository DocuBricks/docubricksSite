...
<div id="main">
	<div class="container">
		<div class="row page-max-width">
			...
			<p>This privacy policy sets out how docubricks uses and protects
				any information that you give docubricks when you use this website.</p>
			<p>Docubricks is committed to ensuring that your privacy is
			...
			<ul>
				...
				<li>
					<div>We may use the information to improve our products and
						services.</div>
				</li>
				<li>
					<div>We may periodically send promotional emails about new
				...
				<li>
					<div>From time to time, we may also use your information to
						...
						the website according to your interests.</div>
				</li>
			</ul>
			<h3>Security</h3>
			...
			<p>A cookie is a small file which asks permission to be placed on
			...
			<p>
				...
				to <a href="mailto:docubricks@gmail">docubricks@gmail.com</a>.
			</p>
