	...
	<div class="container">
		<div class="row page-max-width">
			...
			<p>
				...
				online repository. The editor helps you document a project along
				it's functionality and in a modular fashion. This is ideal to
				communicate your design rational with all files, media and details
				linked into place - this is different from a simpler linear
				assembly-only documentation for sold part-kits or repair guides and
				well suited for open hardware projects.</p>
			<p>	
			...
			<p>
				The editor will save your project into a XML document and a folder
				with your files (images, videos, CAD, etc.), which you can save on your PC
				or host for example on GitHub to re-open, modify or fork later. Once you
				are ready to submit the project to this repository, please upload the files under
			...
			<p>	
				...
				The DocuBricks XML scheme is the standard we develop for effective open hardware documentations.
