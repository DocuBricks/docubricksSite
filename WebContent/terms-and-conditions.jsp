	...
	<div class="container">
		<div class="row page-max-width">
			...
			<ul>
				...
				<li>All trade marks reproduced in this website which are not
					the property of, or licensed to, the operator are acknowledged on
					the website.</li>
				<li>Unauthorised use of this website may give rise to a claim
				...
				<li>From time to time this website may also include links to
					...
					linked website(s).</li>
				<li>Your use of this website and any dispute arising out of
					such use of the website is subject to the laws of England, Northern
					Ireland, Scotland and Wales.</li>
			</ul>
			<p>The information contained in this website is for general
				information purposes only. The information is provided by docubricks
			...
			<p>Through this website you are able to link to other websites
				which are not under the control of docubricks. We have no control
