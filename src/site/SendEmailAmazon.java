...
/*
    static final String FROM = "noreply@docubricks.com";  // Replace with your "From" address. This address must be verified.
    ...
    static final String SUBJECT = "DocuBricks password reset";
    */
